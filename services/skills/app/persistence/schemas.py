...
class SkillCreate(BaseModel):
    ...
    skill_name: str = Field(..., min_length=1, max_length=255, description="Nombre de la habilidad")
...
class SkillUpdate(BaseModel):
    ...
    skill_name: Optional[str] = Field(None, min_length=1, max_length=255, description="Nombre de la habilidad")
