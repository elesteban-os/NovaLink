...
def test_create_notification_crud(db_session):
    ...
    log_info("[TEST] Ejecutando: test_create_notification_crud -> crear notificación usando CRUD")
    ...
    log_assert_equal("Verifica persistencia en base de datos", persisted.description, "persisted.description")
